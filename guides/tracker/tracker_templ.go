...
func Page(g guides.Guide, htmxRequest bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var4 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 19, "<div class=\"trk-panel p-6 mb-6\"><p class=\"mb-4\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase;\">DISPLAY — SPACE MONO</p><p class=\"trk-glow mb-3\" style=\"font-family: var(--font-display); font-size: var(--font-size-display); font-weight: 700; color: var(--color-primary);\">Mission Control</p><p class=\"mb-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-heading); font-weight: 700; color: var(--color-text);\">HEADING — Account Overview</p><p class=\"mb-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-body); font-weight: 400; color: var(--color-text);\">Body Mono — Total Level: 1,854</p><p style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 400; color: var(--color-text-muted);\">Caption Mono — LAST UPDATED: 2026-03-07T14:30:00Z</p></div><div class=\"trk-panel p-6 mb-6\"><p class=\"mb-4\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase;\">BODY — SPACE MONO</p><p class=\"mb-2\" style=\"font-family: var(--font-body); font-size: var(--font-size-heading); font-weight: 700;\">Heading Weight 700</p><p class=\"mb-2\" style=\"font-family: var(--font-body); font-size: var(--font-size-body); font-weight: 400;\">Body text at regular weight. Track your goals, monitor quest completion, and visualize account progression.</p><p style=\"font-family: var(--font-body); font-size: var(--font-size-caption); color: var(--color-text-muted);\">Caption — Updated 2 hours ago</p></div><div class=\"trk-panel p-6\"><div class=\"trk-panel-header mb-0\" style=\"margin: -1.5rem -1.5rem 1rem;\">DATA READOUT PANEL</div><div class=\"grid grid-cols-2 sm:grid-cols-4 gap-4\"><div><p style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700;\">TOTAL LEVEL:</p><p class=\"trk-readout\">1,854</p></div><div><p style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700;\">QUEST POINTS:</p><p class=\"trk-readout\">245</p></div><div><p style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700;\">COMBAT LVL:</p><p class=\"trk-readout\">118</p></div><div><p style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700;\">DIARIES:</p><p class=\"trk-readout\">32</p></div></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
