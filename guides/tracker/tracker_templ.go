...
func Page(g guides.Guide, htmxRequest bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if htmxRequest {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `guides/tracker/tracker.templ`, Line: 16, Col: 42}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<div style=\"background: var(--color-bg); min-height: 100%; padding: var(--section-padding); color: var(--color-text); font-family: var(--font-body);\"><div style=\"max-width: var(--content-max-width); margin: 0 auto;\"><!-- HEADER --><h1 class=\"trk-glow mb-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-display); font-weight: 700; color: var(--color-primary);\">Mission Control</h1><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\">Goal Tracker — Dark-mode dashboard for learning progression.</p><div class=\"trk-rule mt-4 mb-8\"></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Var3 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "><div style=\"height: 48px; background: #161b22; border: 1px solid var(--color-border); \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Surface</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='surface' ? 'COPIED' : '#161b22'\">#161b22</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Panel / Card</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "><div style=\"height: 48px; background: #1c2128; border: 1px solid var(--color-border); \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Surface 2</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='surface2' ? 'COPIED' : '#1c2128'\">#1c2128</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Headers / Elevated</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "><div style=\"height: 48px; background: #c8aa6e; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Primary / Gold</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='primary' ? 'COPIED' : '#c8aa6e'\">#c8aa6e</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Accent / Headings</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "><div style=\"height: 48px; background: #d29922; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Warning / Amber</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='warning' ? 'COPIED' : '#d29922'\">#d29922</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">In-progress</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "><div style=\"height: 48px; background: #da3633; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Danger / Red</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='danger' ? 'COPIED' : '#da3633'\">#da3633</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Locked / Error</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "><div style=\"height: 48px; background: #58a6ff; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Info / Blue</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='info' ? 'COPIED' : '#58a6ff'\">#58a6ff</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Links / Skill tags</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "><div style=\"height: 48px; background: #e6edf3; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Text</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='text' ? 'COPIED' : '#e6edf3'\">#e6edf3</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Body text</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "><div style=\"height: 48px; background: #7d8590; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Muted</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='muted' ? 'COPIED' : '#7d8590'\">#7d8590</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Secondary text</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 17, "><div style=\"height: 48px; background: #30363d; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Border</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='border' ? 'COPIED' : '#30363d'\">#30363d</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Dividers / Edges</p></div></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		...
		templ_7745c5c3_Var5 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 21, "<div class=\"trk-panel p-6\"><p class=\"mb-4\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase;\">PROGRESS BAR SCALE — BASE UNIT 4PX</p><div class=\"space-y-3\"><div class=\"flex items-center gap-4\"><span style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); width: 3.5rem; text-align: right; flex-shrink: 0;\">4px</span><div class=\"trk-progress-bar flex-1\"><div class=\"trk-progress-fill\" style=\"width: 6.25%;\"></div></div></div><div class=\"flex items-center gap-4\"><span style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); width: 3.5rem; text-align: right; flex-shrink: 0;\">8px</span><div class=\"trk-progress-bar flex-1\"><div class=\"trk-progress-fill\" style=\"width: 12.5%;\"></div></div></div><div class=\"flex items-center gap-4\"><span style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); width: 3.5rem; text-align: right; flex-shrink: 0;\">12px</span><div class=\"trk-progress-bar flex-1\"><div class=\"trk-progress-fill\" style=\"width: 18.75%;\"></div></div></div><div class=\"flex items-center gap-4\"><span style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); width: 3.5rem; text-align: right; flex-shrink: 0;\">16px</span><div class=\"trk-progress-bar flex-1\"><div class=\"trk-progress-fill\" style=\"width: 25%;\"></div></div></div><div class=\"flex items-center gap-4\"><span style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); width: 3.5rem; text-align: right; flex-shrink: 0;\">24px</span><div class=\"trk-progress-bar flex-1\"><div class=\"trk-progress-fill\" style=\"width: 37.5%;\"></div></div></div><div class=\"flex items-center gap-4\"><span style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); width: 3.5rem; text-align: right; flex-shrink: 0;\">32px</span><div class=\"trk-progress-bar flex-1\"><div class=\"trk-progress-fill\" style=\"width: 50%;\"></div></div></div><div class=\"flex items-center gap-4\"><span style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); width: 3.5rem; text-align: right; flex-shrink: 0;\">48px</span><div class=\"trk-progress-bar flex-1\"><div class=\"trk-progress-fill\" style=\"width: 75%;\"></div></div></div><div class=\"flex items-center gap-4\"><span style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); width: 3.5rem; text-align: right; flex-shrink: 0;\">64px</span><div class=\"trk-progress-bar flex-1\"><div class=\"trk-progress-fill\" style=\"width: 100%;\"></div></div></div></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		...
		templ_7745c5c3_Var6 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 24, " x-text=\"tracking ? 'Untrack' : 'Track'\">Track</button><div class=\"flex items-center gap-2\"><span class=\"trk-status-light\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 25, "></span> <span style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"tracking ? 'TRACKING' : 'NOT TRACKED'\">NOT TRACKED</span></div></div><!-- /snippet:btn-toggle --></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		...
		templ_7745c5c3_Err = components.Section("4.0  Buttons", components.BadgeAlpine).Render(templ.WithChildren(ctx, templ_7745c5c3_Var6), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 26, "<!-- SECTION 5: Forms -->")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Var7 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 27, "<div class=\"trk-panel\"><div class=\"trk-panel-header\">ADD GOAL</div><div class=\"p-6\"><form hx-post=\"/guides/tracker/demo-form\" hx-target=\"#trk-form-response\" hx-swap=\"innerHTML\"><div class=\"space-y-4\"><div><label style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.04em; display: block; margin-bottom: 0.25rem;\">GOAL NAME</label> <input type=\"text\" name=\"name\" class=\"trk-input\" placeholder=\"e.g. Learn Kubernetes\"></div><div><label style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.04em; display: block; margin-bottom: 0.25rem;\">CATEGORY</label> <select name=\"category\" class=\"trk-input\"><option value=\"skill\">Skill</option> <option value=\"project\">Project</option> <option value=\"certification\">Certification</option> <option value=\"challenge\">Challenge</option> <option value=\"other\">Other</option></select></div><div><label style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.04em; display: block; margin-bottom: 0.5rem;\">PRIORITY</label><div class=\"flex items-center gap-6\"><label class=\"flex items-center gap-2 cursor-pointer\" style=\"font-size: var(--font-size-body);\"><input type=\"radio\" name=\"priority\" value=\"low\"> <span>Low</span></label> <label class=\"flex items-center gap-2 cursor-pointer\" style=\"font-size: var(--font-size-body);\"><input type=\"radio\" name=\"priority\" value=\"normal\" checked> <span>Normal</span></label> <label class=\"flex items-center gap-2 cursor-pointer\" style=\"font-size: var(--font-size-body);\"><input type=\"radio\" name=\"priority\" value=\"high\"> <span>High</span></label></div></div><div><label class=\"flex items-center gap-2 cursor-pointer\" style=\"font-size: var(--font-size-body);\"><input type=\"checkbox\" name=\"notifications\" value=\"on\"> <span>Enable notifications</span></label></div><div><button type=\"submit\" class=\"trk-btn trk-btn-primary\">Submit Goal</button></div></div></form><div id=\"trk-form-response\" class=\"mt-4\"></div></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		})
		templ_7745c5c3_Err = components.Section("5.0  Forms", components.BadgeBoth).Render(templ.WithChildren(ctx, templ_7745c5c3_Var7), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 28, "<!-- SECTION 6: Cards / Panels -->")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = components.Section("6.0  Cards / Panels", components.BadgeAlpine).Render(templ.WithChildren(ctx, templ_7745c5c3_Var8), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Var11 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 71, "<!-- Top row: Skills Mastered + Projects Complete --> <div class=\"flex flex-col sm:flex-row gap-6 mb-6\"><!-- Skills Mastered --><div class=\"trk-panel p-6 flex-1\"><div class=\"trk-readout\">2 / 8</div><div class=\"trk-progress-bar mt-3\"><div class=\"trk-progress-fill\" style=\"width: 25%;\"></div></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase;\">SKILLS MASTERED</p></div><!-- Projects Complete --><div class=\"trk-panel p-6 flex-1\"><div class=\"trk-readout\">2 / 6</div><div class=\"trk-progress-bar mt-3\"><div class=\"trk-progress-fill\" style=\"width: 33%;\"></div></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase;\">PROJECTS COMPLETE</p></div></div><!-- Middle row: Skill Completion Grid + Certification Tiers --> <div class=\"flex flex-col sm:flex-row gap-6 mb-6\"><!-- Skill Completion Grid --><div class=\"trk-panel p-6 flex-1\"><p class=\"mb-4\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase;\">SKILL COMPLETION</p><div class=\"flex flex-wrap gap-3\"><!-- Go 75/99: progress --><span class=\"trk-status-light trk-status-progress\" title=\"Go — 75/99\"></span><!-- JavaScript 82/99: progress --><span class=\"trk-status-light trk-status-progress\" title=\"JavaScript — 82/99\"></span><!-- Python 70/70: complete --><span class=\"trk-status-light trk-status-complete trk-glow\" title=\"Python — 70/70\"></span><!-- Rust 80/99: progress --><span class=\"trk-status-light trk-status-progress\" title=\"Rust — 80/99\"></span><!-- SQL 52/77: progress --><span class=\"trk-status-light trk-status-progress\" title=\"SQL — 52/77\"></span><!-- Docker 85/99: progress --><span class=\"trk-status-light trk-status-progress\" title=\"Docker — 85/99\"></span><!-- Git 72/85: progress --><span class=\"trk-status-light trk-status-progress\" title=\"Git — 72/85\"></span><!-- TypeScript 70/70: complete --><span class=\"trk-status-light trk-status-complete trk-glow\" title=\"TypeScript — 70/70\"></span></div></div><!-- Certification Tiers --><div class=\"trk-panel p-6 flex-1\"><p class=\"mb-4\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase;\">CERTIFICATION TIERS</p><div class=\"flex flex-col gap-4\"><div><div class=\"flex justify-between mb-1\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 600;\"><span>Foundational</span> <span style=\"color: var(--color-text-muted);\">1 / 1</span></div><div class=\"trk-progress-bar\"><div class=\"trk-progress-fill\" style=\"width: 100%;\"></div></div></div><div><div class=\"flex justify-between mb-1\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 600;\"><span>Associate</span> <span style=\"color: var(--color-text-muted);\">0 / 1</span></div><div class=\"trk-progress-bar\"><div class=\"trk-progress-fill\" style=\"width: 0%;\"></div></div></div><div><div class=\"flex justify-between mb-1\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 600;\"><span>Professional</span> <span style=\"color: var(--color-text-muted);\">0 / 1</span></div><div class=\"trk-progress-bar\"><div class=\"trk-progress-fill\" style=\"width: 0%;\"></div></div></div><div><div class=\"flex justify-between mb-1\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 600;\"><span>Specialty</span> <span style=\"color: var(--color-text-muted);\">0 / 0</span></div><div class=\"trk-progress-bar\"><div class=\"trk-progress-fill\" style=\"width: 0%;\"></div></div></div></div></div></div><!-- Bottom row: Readiness Score Calculator --> <!-- snippet:readiness-calc --> <div class=\"trk-panel p-6\" x-data=\"{\n\t\t\t\t\t\tgolang: 75, javascript: 82, python: 70, sql: 52,\n\t\t\t\t\t\tdocker: 85, git: 72, systemDesign: 30,\n\t\t\t\t\t\tget readinessScore() {\n\t\t\t\t\t\t\tlet w = { golang: 0.20, javascript: 0.15, python: 0.10, sql: 0.15, docker: 0.15, git: 0.10, systemDesign: 0.15 };\n\t\t\t\t\t\t\tlet score = this.golang * w.golang + this.javascript * w.javascript + this.python * w.python + this.sql * w.sql + this.docker * w.docker + this.git * w.git + this.systemDesign * w.systemDesign;\n\t\t\t\t\t\t\treturn Math.round(score);\n\t\t\t\t\t\t}\n\t\t\t\t\t}\"><p class=\"mb-4\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase;\">READINESS SCORE</p><div class=\"trk-readout mb-4\" x-text=\"readinessScore\"></div><div class=\"grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4\"><div><label style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 600; display: block; margin-bottom: 0.25rem;\">Go</label> <input type=\"number\" min=\"1\" max=\"100\" class=\"trk-input\" x-model.number=\"golang\"></div><div><label style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 600; display: block; margin-bottom: 0.25rem;\">JavaScript</label> <input type=\"number\" min=\"1\" max=\"100\" class=\"trk-input\" x-model.number=\"javascript\"></div><div><label style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 600; display: block; margin-bottom: 0.25rem;\">Python</label> <input type=\"number\" min=\"1\" max=\"100\" class=\"trk-input\" x-model.number=\"python\"></div><div><label style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 600; display: block; margin-bottom: 0.25rem;\">SQL</label> <input type=\"number\" min=\"1\" max=\"100\" class=\"trk-input\" x-model.number=\"sql\"></div><div><label style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 600; display: block; margin-bottom: 0.25rem;\">Docker</label> <input type=\"number\" min=\"1\" max=\"100\" class=\"trk-input\" x-model.number=\"docker\"></div><div><label style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 600; display: block; margin-bottom: 0.25rem;\">Git</label> <input type=\"number\" min=\"1\" max=\"100\" class=\"trk-input\" x-model.number=\"git\"></div><div><label style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 600; display: block; margin-bottom: 0.25rem;\">System Design</label> <input type=\"number\" min=\"1\" max=\"100\" class=\"trk-input\" x-model.number=\"systemDesign\"></div></div></div><!-- /snippet:readiness-calc --> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
