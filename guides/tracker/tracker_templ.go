...
func Page(g guides.Guide, htmxRequest bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":style": "copied==='bg' ? 'border-color: var(--color-primary)' : 'border-color: transparent'"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "><div style=\"height: 48px; background: #f7f6f3; border: 1px solid var(--color-border); \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Background</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='bg' ? 'COPIED' : '#f7f6f3'\">#f7f6f3</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Page background</p></div><!-- /snippet:color-swatch --><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":style": "copied==='surface' ? 'border-color: var(--color-primary)' : 'border-color: transparent'"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "><div style=\"height: 48px; background: #ffffff; border: 1px solid var(--color-border); \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Surface</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='surface' ? 'COPIED' : '#ffffff'\">#ffffff</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Panel / Card</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":style": "copied==='surface2' ? 'border-color: var(--color-primary)' : 'border-color: transparent'"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "><div style=\"height: 48px; background: #edecea; border: 1px solid var(--color-border); \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Surface 2</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='surface2' ? 'COPIED' : '#edecea'\">#edecea</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Headers / Elevated</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":style": "copied==='primary' ? 'border-color: var(--color-primary)' : 'border-color: transparent'"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "><div style=\"height: 48px; background: #d45b2c; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Primary / Orange</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='primary' ? 'COPIED' : '#d45b2c'\">#d45b2c</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Accent / Headings</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":style": "copied==='success' ? 'border-color: var(--color-primary)' : 'border-color: transparent'"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "><div style=\"height: 48px; background: #3a8a5c; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Complete</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='success' ? 'COPIED' : '#3a8a5c'\">#3a8a5c</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Complete status</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":style": "copied==='warning' ? 'border-color: var(--color-primary)' : 'border-color: transparent'"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "><div style=\"height: 48px; background: #c4880b; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Progress</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='warning' ? 'COPIED' : '#c4880b'\">#c4880b</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">In-progress</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":style": "copied==='danger' ? 'border-color: var(--color-primary)' : 'border-color: transparent'"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "><div style=\"height: 48px; background: #b53d2e; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Locked</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='danger' ? 'COPIED' : '#b53d2e'\">#b53d2e</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Locked / Error</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":style": "copied==='info' ? 'border-color: var(--color-primary)' : 'border-color: transparent'"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "><div style=\"height: 48px; background: #3d7ec7; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Info / Links</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='info' ? 'COPIED' : '#3d7ec7'\">#3d7ec7</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Links / Info</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":style": "copied==='text' ? 'border-color: var(--color-primary)' : 'border-color: transparent'"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "><div style=\"height: 48px; background: #2c2c2c; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Text</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='text' ? 'COPIED' : '#2c2c2c'\">#2c2c2c</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Body text</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":style": "copied==='muted' ? 'border-color: var(--color-primary)' : 'border-color: transparent'"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "><div style=\"height: 48px; background: #8a8780; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Muted</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='muted' ? 'COPIED' : '#8a8780'\">#8a8780</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Secondary text</p></div><div class=\"trk-panel p-3 cursor-pointer transition-all\" style=\"border-color: transparent;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":style": "copied==='border' ? 'border-color: var(--color-primary)' : 'border-color: transparent'"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "><div style=\"height: 48px; background: #dddbd6; \"></div><p class=\"mt-2\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); font-weight: 700;\">Border</p><p style=\"font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"copied==='border' ? 'COPIED' : '#dddbd6'\">#dddbd6</p><p style=\"font-size: 0.625rem; color: var(--color-text-muted);\">Dividers / Edges</p></div></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 19, "<!-- SECTION 4: Buttons -->")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Var5 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 20, "<div class=\"trk-panel p-6 mb-6\"><p class=\"mb-4\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.01em;\">Size variants</p><div class=\"flex flex-wrap items-center gap-3 mb-6\"><button class=\"trk-btn\" style=\"font-size: 0.625rem; padding: 0.25rem 0.75rem;\">SM</button> <button class=\"trk-btn\">MD</button> <button class=\"trk-btn\" style=\"font-size: var(--font-size-body); padding: 0.6rem 1.5rem;\">LG</button></div><p class=\"mb-4\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.01em;\">Style variants</p><div class=\"flex flex-wrap items-center gap-3\"><button class=\"trk-btn\">Default</button> <button class=\"trk-btn trk-btn-primary\">Primary</button> <button class=\"trk-btn trk-btn-danger\">Danger</button> <button class=\"trk-btn\" disabled style=\"opacity: 0.4; cursor: not-allowed;\">Disabled</button></div></div><div class=\"trk-panel p-6\"><p class=\"mb-4\" style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted); font-weight: 700; letter-spacing: 0.01em;\">Toggle demo</p><!-- snippet:btn-toggle --><div x-data=\"{ tracking: false }\" class=\"flex items-center gap-4\"><button class=\"trk-btn\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{"@click": "tracking = !tracking"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":class": "tracking ? 'trk-btn-primary' : ''"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 21, " x-text=\"tracking ? 'Untrack' : 'Track'\">Track</button><div class=\"flex items-center gap-2\"><span class=\"trk-status-light\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":class": "tracking ? 'trk-status-complete' : ''"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 22, "></span> <span style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted);\" x-text=\"tracking ? 'TRACKING' : 'NOT TRACKED'\">NOT TRACKED</span></div></div><!-- /snippet:btn-toggle --></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = components.SourceView(snippets["btn-toggle"]).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		})
		templ_7745c5c3_Err = components.Section("4.0  Buttons", components.BadgeAlpine).Render(templ.WithChildren(ctx, templ_7745c5c3_Var5), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 23, "<!-- SECTION 5: Forms -->")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Var7 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 27, "><span>Search engine — requirements</span> <span style=\"font-size: 0.625rem; transition: transform 0.15s;\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templ.RenderAttributes(ctx, templ_7745c5c3_Buffer, templ.Attributes{":style": "open ? 'transform: rotate(90deg)' : ''"})
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 28, ">&#9654;</span></div><div x-show=\"open\" x-transition x-cloak class=\"p-5\"><div class=\"space-y-3\"><div class=\"flex items-center gap-3\"><span class=\"trk-status-light trk-status-complete\"></span> <span style=\"font-size: var(--font-size-body);\">CLI Todo App</span></div><div class=\"flex items-center gap-3\"><span class=\"trk-status-light trk-status-complete\"></span> <span style=\"font-size: var(--font-size-body);\">REST API</span></div><div class=\"flex items-center gap-3\"><span class=\"trk-status-light trk-status-progress trk-status-pulse\"></span> <span style=\"font-size: var(--font-size-body);\">Go or Rust proficiency</span></div><div class=\"flex items-center gap-3\"><span class=\"trk-status-light trk-status-complete\"></span> <span style=\"font-size: var(--font-size-body);\">Data structures</span></div><div class=\"flex items-center gap-3\"><span class=\"trk-status-light trk-status-complete\"></span> <span style=\"font-size: var(--font-size-body);\">File I/O</span></div></div><div class=\"trk-rule mt-4 pt-3\"><p style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted);\">4/5 requirements met — 1 in progress</p></div></div></div><!-- /snippet:expandable-card --> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = components.SourceView(snippets["expandable-card"]).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		})
		templ_7745c5c3_Err = components.Section("6.0  Cards / Panels", components.BadgeAlpine).Render(templ.WithChildren(ctx, templ_7745c5c3_Var7), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 29, "<!-- SECTION 7: Content Browser -->")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Var8 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 31, "><span class=\"trk-tree-toggle\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 33, "><span class=\"trk-tree-toggle\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 35, "><span class=\"trk-tree-toggle\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 37, "><span class=\"trk-tree-toggle\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 38, ">&#9654;</span> <span>Challenges</span></div><div x-show=\"open.challenges\" x-transition x-cloak style=\"padding-left: 1rem;\"><div class=\"trk-tree-node\" hx-get=\"/guides/tracker/detail/challenge/advent-of-code\" hx-target=\"#trk-detail-panel\" hx-swap=\"innerHTML\"><span class=\"trk-status-light trk-status-complete\"></span> <span>Advent of Code</span></div><div class=\"trk-tree-node\" hx-get=\"/guides/tracker/detail/challenge/leetcode-75\" hx-target=\"#trk-detail-panel\" hx-swap=\"innerHTML\"><span class=\"trk-status-light trk-status-progress trk-status-pulse\"></span> <span>LeetCode 75</span></div><div class=\"trk-tree-node\" hx-get=\"/guides/tracker/detail/challenge/system-design\" hx-target=\"#trk-detail-panel\" hx-swap=\"innerHTML\"><span class=\"trk-status-light trk-status-locked\"></span> <span>System Design</span></div></div></div></div></div><!-- Detail Panel --><div id=\"trk-detail-panel\" class=\"trk-panel p-6\" style=\"flex: 1; min-height: 300px;\"><p style=\"font-family: var(--font-display); font-size: var(--font-size-caption); color: var(--color-text-muted);\">Select an item to view details</p></div></div><!-- /snippet:content-browser --> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		...
		templ_7745c5c3_Err = components.Section("7.0  Content Browser", components.BadgeBoth).Render(templ.WithChildren(ctx, templ_7745c5c3_Var8), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 39, "<!-- SECTION 8: Dependency Graph -->")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Var9 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 40, "<!-- snippet:dep-graph --> <div x-data=\"{ selected: 'fullstack', highlighted: null }\"><!-- Goal selector buttons --><div class=\"flex gap-2 mb-6 flex-wrap\"><button class=\"trk-btn\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 41, ">Full-Stack App</button> <button class=\"trk-btn\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 42, ">Senior Engineer</button> <button class=\"trk-btn\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 44, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">JavaScript</div><span class=\"trk-tag trk-tag-skill\">SKILL</span></div><div class=\"trk-dep-node trk-dep-node-complete\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 45, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">SQL</div><span class=\"trk-tag trk-tag-skill\">SKILL</span></div><div class=\"trk-dep-node trk-dep-node-complete\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 47, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">Go proficiency</div><span class=\"trk-tag trk-tag-skill\">SKILL</span></div><div class=\"trk-dep-node trk-dep-node-progress\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 48, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">Database design</div><span class=\"trk-tag trk-tag-skill\">SKILL</span></div><div class=\"trk-dep-node trk-dep-node-complete\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 49, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">REST API</div><span class=\"trk-tag trk-tag-project\">PROJECT</span></div><div class=\"trk-dep-node trk-dep-node-progress\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 50, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">Docker</div><span class=\"trk-tag trk-tag-skill\">SKILL</span></div><div class=\"trk-dep-node trk-dep-node-complete\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 53, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">Docker</div><span class=\"trk-tag trk-tag-skill\">SKILL</span></div><div class=\"trk-dep-node trk-dep-node-progress\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 54, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">Linux admin</div><span class=\"trk-tag trk-tag-skill\">SKILL</span></div><div class=\"trk-dep-node trk-dep-node-progress\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 56, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">All projects complete</div><span class=\"trk-tag trk-tag-project\">PROJECT</span></div><div class=\"trk-dep-node trk-dep-node-locked\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 57, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">System design</div><span class=\"trk-tag trk-tag-challenge\">CHALLENGE</span></div><div class=\"trk-dep-node trk-dep-node-progress\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 58, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">Docker mastery</div><span class=\"trk-tag trk-tag-skill\">SKILL</span></div><div class=\"trk-dep-node trk-dep-node-locked\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 59, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">CKA cert</div><span class=\"trk-tag trk-tag-certification\">CERT</span></div></div><!-- Connecting lines: deps to goal --><div class=\"flex flex-col gap-2 justify-center\"><div class=\"trk-dep-line\"></div><div class=\"trk-dep-line\"></div><div class=\"trk-dep-line\"></div><div class=\"trk-dep-line\"></div></div><!-- Goal node (right) --><div class=\"flex items-center\"><div class=\"trk-dep-node trk-dep-node-locked\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 60, " style=\"cursor: pointer; padding: 1rem 1.25rem; min-width: 160px;\"><div style=\"font-weight: 700; font-size: var(--font-size-body);\">Senior Engineer</div><span class=\"trk-tag trk-tag-challenge\">CHALLENGE</span></div></div></div><!-- AWS Solutions Architect graph --><div x-show=\"selected === 'awssa'\" x-transition class=\"flex items-start gap-0 overflow-x-auto pb-4\"><!-- No sub-deps for AWS SA, so skip that column --><!-- Deps column --><div class=\"flex flex-col gap-2 justify-center\"><div class=\"trk-dep-node trk-dep-node-complete\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 61, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">AWS CCP</div><span class=\"trk-tag trk-tag-certification\">CERT</span></div><div class=\"trk-dep-node trk-dep-node-progress\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 62, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">Networking</div><span class=\"trk-tag trk-tag-skill\">SKILL</span></div><div class=\"trk-dep-node trk-dep-node-progress\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 63, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">Security</div><span class=\"trk-tag trk-tag-skill\">SKILL</span></div><div class=\"trk-dep-node trk-dep-node-complete\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 64, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">Database design</div><span class=\"trk-tag trk-tag-skill\">SKILL</span></div><div class=\"trk-dep-node trk-dep-node-progress\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 65, " style=\"cursor: pointer;\"><div style=\"font-weight: 600;\">Cost optimization</div><span class=\"trk-tag trk-tag-skill\">SKILL</span></div></div><!-- Connecting lines: deps to goal --><div class=\"flex flex-col gap-2 justify-center\"><div class=\"trk-dep-line\"></div><div class=\"trk-dep-line\"></div><div class=\"trk-dep-line\"></div><div class=\"trk-dep-line\"></div><div class=\"trk-dep-line\"></div></div><!-- Goal node (right) --><div class=\"flex items-center\"><div class=\"trk-dep-node trk-dep-node-progress\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 66, " style=\"cursor: pointer; padding: 1rem 1.25rem; min-width: 160px;\"><div style=\"font-weight: 700; font-size: var(--font-size-body);\">AWS Solutions Architect</div><span class=\"trk-tag trk-tag-certification\">CERT</span></div></div></div></div><!-- /snippet:dep-graph --> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		...
		templ_7745c5c3_Err = components.Section("8.0  Dependency Graph", components.BadgeAlpine).Render(templ.WithChildren(ctx, templ_7745c5c3_Var9), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 67, "<!-- SECTION 9: Learning Overview Dashboard -->")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = components.Section("9.0  Learning Overview", components.BadgeAlpine).Render(templ.WithChildren(ctx, templ_7745c5c3_Var10), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
